          ...
          <div className="flex flex-col md:flex-row gap-6 bg-gray-100">
            ...
            <div className="w-full md:w-1/4">
              <button
                ...
                className="mt-6 w-full md:w-auto bg-white/60 backdrop-blur-sm text-gray-800 px-4 py-2 rounded-lg hover:bg-white shadow-sm border border-gray-300 flex items-center gap-2 text-sm transition"
              >
